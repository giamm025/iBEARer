...
class ModifyPostIntervention extends BaseIntervention {
    
    constructor() {
        // Usa il FQN esatto con cui vuoi richiamare l'intervento nel config.json
        super("modifyPost");
    }

    /**
     * @param {ModifyPostPayload} payload 
                ...
                if (isPosTarget || isKeywordTarget) {
                    ...
                    if (mainFeedContainer) {
                        ...
                        if (wrapper && !wrapper.dataset.bearModified) {
                            this.sendModifiedPostToBackend(wrapper, titleLink, currentPos, initialQuery);
